...
const LEGAL_PAGES: LegalPageSeed[] = [
  {
    ...
    body: [placeholderBlock('privacy-1', 'This policy is managed in Sanity Studio. Replace this block with the full privacy policy text.')],
    seo: {
  ...
  },
  {
    ...
    tag: '\u2726 Terms',
    lastUpdated: '2026-04-15',
    body: [placeholderBlock('terms-1', 'This policy is managed in Sanity Studio. Replace this block with the full terms of service text.')],
    seo: {
  ...
  },
  {
    ...
    tag: '\u2726 Refunds',
    lastUpdated: '2026-04-15',
    body: [placeholderBlock('refund-1', 'This policy is managed in Sanity Studio. Replace this block with the full refund policy text.')],
    seo: {
...
async function main(): Promise<void> {
  ...
  const existing = await client.fetch<Array<{ _id: string; title: string; slug: { current: string } }>>(
