  ...
  return {
    ...
    children: [
      ...
      },
      {
        ...
        text: " — provides anonymous session replay and Core Web Vitals (page-load timing, layout-shift, interactivity) so Josephine can diagnose intake-form friction. Clarity automatically masks form input fields by default — names, dates of birth, photographs, and free-text answers render as redacted blocks in replays. Hosted in the United States; data is transferred under the EU–US Data Privacy Framework and Standard Contractual Clauses. Visitors in the EU/EEA, UK, Switzerland, and California see a consent banner before any session recording; outside those regions, anonymous session recording is enabled by default in line with applicable laws. See ",
        marks: [],
      },
      {
        _type: "span",
