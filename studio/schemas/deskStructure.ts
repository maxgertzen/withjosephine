      ...
      S.list()
        ...
        .items([
          ...
          emailSingletonListItem(
            S,
            "emailGiftPurchaseConfirmationSelfSend",
            "Gift Purchase Confirmation — Self-Send",
          ),
          emailSingletonListItem(
            S,
            "emailGiftPurchaseConfirmationScheduled",
            "Gift Purchase Confirmation — Scheduled",
          ),
          emailSingletonListItem(S, "emailGiftClaim", "Gift Claim — First Send (to recipient)"),
          emailSingletonListItem(
            S,
            "emailGiftClaimReminder",
            "Gift Claim — Reminder (to recipient)",
          ),
          emailSingletonListItem(
            S,
            "emailRecipientIntakeReceived",
          ...
          emailSingletonListItem(S, "emailMagicLink", "Magic Link — Listen"),
