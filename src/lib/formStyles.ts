...
export const inputClasses =
  `peer bg-white/50 border border-j-border-subtle rounded-lg px-4 pt-6 pb-2 min-h-14 font-body text-base text-j-text focus:outline-none focus:border-j-accent ${invalidBorderClasses} w-full placeholder:text-transparent`;
