    ...
    <LegalPageLayout tag={tag} title={title} lastUpdated={lastUpdated}>
      {doc?.body?.length ? (
        ...
        <>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            Solely to create and deliver your reading, to contact you about it, and to comply with
            tax and accounting obligations. Your information is not used for marketing and is not
          ...
          <p className="font-body text-base text-j-text-muted leading-[1.9] font-light mt-3">
            Each processor has its own privacy policy. Data shared with them is limited to
            what&rsquo;s needed for that specific function.
          </p>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            Josephine works remotely and may access your information from countries outside the
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            ...
            is collected about you, to request its deletion, and to correct inaccurate information.
            Josephine does not{" "}
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            When this policy changes, the &ldquo;Last updated&rdquo; date at the top will change
            too. Material changes will be flagged on the homepage for a reasonable period.
          </p>
