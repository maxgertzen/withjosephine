...
export type MyReadingsViewProps = {
  ...
  state:
    | { kind: "list"; readings: SubmissionRecord[]; gifts: SubmissionRecord[] }
    | { kind: "signIn" }
    | { kind: "checkEmail" };
};

export function MyReadingsView({ readingsCopy, giftsCopy, state }: MyReadingsViewProps) {
  return (
    <div className="relative min-h-screen bg-j-cream overflow-hidden">
      ...
      <main className="relative z-10 max-w-[720px] mx-auto px-6 py-20">
        {state.kind === "list" ? (
          ...
          <AuthGatedPage state={state.kind} copy={readingsCopy} resendHref="/my-readings" />
        )}
        <Footer />
      </main>
    </div>
...
function ReadingsAndGiftsList({
  ...
  return (
    <>
      ...
      <section aria-labelledby="my-readings-mine-heading">
        <h2
          id="my-readings-mine-heading"
      ...
      <section aria-labelledby="my-readings-for-others-heading">
        <h2
          id="my-readings-for-others-heading"
          className="font-display italic text-2xl text-j-text-heading"
        >
