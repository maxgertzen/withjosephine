...
//   1. process.env.E2E === "1"                          (build-time)
//   2. NEXT_PUBLIC_SANITY_DATASET !== "production"      (env-misconfig safety)
...
function gatesOpen(request: Request): boolean {
  ...
  if (process.env.NEXT_PUBLIC_SANITY_DATASET === "production") return false;
