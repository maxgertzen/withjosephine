        ...
        <>
          <section className="flex flex-col gap-5">
            <p className="font-body text-base text-j-text leading-[1.9] font-light">
              Because each reading is created personally by Josephine — not generated, not templated
            ...
            <p className="font-body text-base text-j-text-muted leading-[1.9] font-light">
              The single moment that decides refund eligibility is whether you&rsquo;ve submitted
              the intake form. The rest of this page explains what that means in practice.
            </p>
          </section>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            ...
            <strong className="font-medium">you have not yet submitted the intake form</strong> (the
            Google Form sent to you after booking). Request within{" "}
          ...
          <ul className="mt-3 flex flex-col gap-3 font-body text-base text-j-text leading-[1.9] font-light list-disc pl-5">
            ...
            <li>You were charged by accident (for example, a duplicate payment).</li>
          </ul>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            Once you have{" "}
            <strong className="font-medium">submitted the intake form to Josephine</strong>, your
            reading has effectively started: she uses those details to begin her research and chart
            work. At that point the reading is no longer refundable.
          </p>
          <p className="font-body text-base text-j-text leading-[1.9] font-light mt-3">
            This also applies once the reading has been delivered (voice note + PDF sent to your
            email).
          </p>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            ...
            receipt. The duplicate or unintended charge will be refunded in full regardless of the
            rules above.
          </p>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            ...
            <strong className="font-medium">14 days</strong> of receiving your completed intake
            form, and has not been in touch with a revised timeline, email <ContactEmailLink />. A
            refund in this case is given as a matter of good faith.
          </p>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            ...
            content of a completed reading is not by itself grounds for a refund. If something about
            your reading felt wrong, Josephine would genuinely like to hear about it — email her at{" "}
            <ContactEmailLink />.
          </p>
          ...
          <ol className="flex flex-col gap-3 font-body text-base text-j-text leading-[1.9] font-light list-decimal pl-5">
            <li>
              Email <ContactEmailLink /> from the address used at checkout.
            </li>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light mt-3">
            ...
            <strong className="font-medium">5–10 business days</strong> back to the original payment
            method. Your bank may take a further 5–10 business days to credit it.
          </p>
          ...
          <p className="font-body text-base text-j-text leading-[1.9] font-light">
            Nothing in this policy overrides any non-waivable consumer rights you may have under the
