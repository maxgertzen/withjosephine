...
- **T8.21-23 — Studio document actions** (regenerateGiftClaim, editGiftRecipient, markBounced). **Revisit trigger:** Becky onboarding — let her tell us which CLI primitives she needs as Studio buttons before we build them.
